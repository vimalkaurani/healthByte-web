...
var gulp       = require('gulp'),
    ...
    mixpanel = require('gulp-mixpanel'),
...
gulp.task('default', function(){
    runSynchronized(['mixpanel', 'compress', 'prod', 'sass', 'newRelic']);
});
...
gulp.task('prod', function() {
    gulp.src('app/index.html')
        .pipe(htmlreplace({
            js: {
                src: [['/dist/bootstrap.js', 'vendor/requirejs/require.js']],
                tpl: '<script type="text/javascript" data-main="%s" src="%s"></script>'
            }
        }))
        .pipe(gulp.dest('app/'));
});
...
gulp.task('sass', function(){
    return gulp.src('app/style/scss/fit.scss')
...
gulp.task('version', function(){
    ...
    gulp.src(['app/dist/bootstrap.js'])
        .pipe(replace('@hash', value))
        .pipe(gulp.dest('app/dist/'));
});
...
gulp.task('staging', function(){
    runSynchronized(['compress', 'prod', 'sass', 'mixpanel']);
});
/*End For staging*/

/*For dev*/
gulp.task('development', function(){
    runSynchronized(['mixpanel', 'sass', 'watch']);
});
/*End For dev*/
...
gulp.task('watch', function(){
    gulp.watch('app/style/scss/fit.scss', ['sass']);
})
...
gulp.task('dev', function() {
    gulp.src('app/index.html')
        .pipe(htmlreplace({
            js: {
                src: [['/scripts/bootstrap.js', 'vendor/requirejs/require.js']],
                tpl: '<script type="text/javascript" data-main="%s" src="%s"></script>'
            }
        }))
        .pipe(gulp.dest('app/'));
